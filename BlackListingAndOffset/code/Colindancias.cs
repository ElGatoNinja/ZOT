...
public class Colindancias : GenericTable
{
    ...
    public Colindancias()
    {
        ...
        data.Columns["distancia"].DataType = typeof(double); //Si se deja como string la ordenacion es por orden alfabético en vez de numerico
    }
        ...
        { 
            ...
            foreach (DataRow match in matchArray)
            {
                ...
                if (match.Field<string>("Target LNCEL name") == exportRow.Field<string>("dstName"))
                {
                    ...
                    aux = new object[13]{ exportRow["Label"],exportRow["mrbtsId"],exportRow["lnCelId"], exportRow["srcName"],exportRow["ecgiAdjEnbId"],exportRow["ecgiLcrId"],exportRow["dstName"],dist,HOsucc,exportRow["cellIndOffNeigh"], HOatem,exportRow["handoverAllowed"]/*,HOsuccSR*/,interfaceX2};
                }
                else
                {
                    interfaceX2 = (int)exportRow["x2LinkStatus"];
                    aux = new object[13] { exportRow["Label"], exportRow["mrbtsId"], exportRow["lnCelId"], exportRow["srcName"], exportRow["ecgiAdjEnbId"], exportRow["ecgiLcrId"], exportRow["dstName"], dist, "", exportRow["cellIndOffNeigh"], "", exportRow["handoverAllowed"]/*,HOsuccSR*/, interfaceX2 };
                }
    ...
    public void CheckColinsJustInR31(DataRow line)
    {
        double dist;
        double HOatem;
        double HOsucc;
