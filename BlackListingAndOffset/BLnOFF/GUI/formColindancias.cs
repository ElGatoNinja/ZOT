...
{
    public partial class formColindancias : Form
    {
        ...
        public formColindancias(DataTable colindancias)
        {
        ...
        public void inyectarTabla()
        {
            ...
            advancedDataGridViewCol.ScrollBars = ScrollBars.Both;
        ...
        private void advancedDataGridViewCol_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
